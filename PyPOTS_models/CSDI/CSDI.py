...
from pypots.nn.functional import gather_listed_dicts
...
class CSDI(BaseNNImputer):
    ...
    def __init__(
        ...
        d_feature_embedding=args.model_dim
        d_time_embedding=args.d_time_embedding
        d_diffusion_embedding=args.model_dim
    ...
    def impute(
        ...
        assert n_sampling_times > 0, "n_sampling_times should be greater than 0."
        result_dict = self.predict(test_set, file_type, n_sampling_times=n_sampling_times)

...
from pypots.nn.modules.imputeformer import (
...
class _ImputeFormer(ModelCore):
    ...
    def __init__(
        ...
        if validation_metric.__class__.__name__ == "Criterion":
            ...
            print(f"self.validation_metric: {self.validation_metric}")
        else:
    ...
    def forward(
        ...
        if calc_criterion:
            ...
            if self.training:  # if in the training mode (the training stage), return loss result from training_loss
                ...
                results["metric"] = self.validation_metric(reconstruction, X_ori, torch.ones_like(indicating_mask))
